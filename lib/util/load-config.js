...
module.exports = function (options) {
  var config = {
    ...
    devServer: {},
    resolve: {
      modules: ['node_modules', _path2.default.resolve(process.cwd(), 'node_modules'), _path2.default.resolve(__dirname, '../../node_modules')].concat(options.modules).filter(_is2.default.valid)
    }
  };
  // node env
  ...
  if (options.template !== false) {
    (0, _assign2.default)(config.plugins, (0, _loadTemplate2.default)(options.template));
  }
  // alias
  if (options.alias) {
